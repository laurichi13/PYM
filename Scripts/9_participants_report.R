...
#Prepare data
physeq.rel ### Phyloseq object transformed for CoDA analysis 
...
Phyl <- tax_glom(physeq.rel, taxrank = "Phylum") 
tb_phyl <- psmelt(Phyl) 
...
#Percentage of Phylum by sample####
...
#Prepare data and labels for plot####
...
tb <- psmelt(physeq.rel) 

#Genus of interest Akkermansia, Bifidobacterium, Lactobacillus, Alistipes, Bacteroides, Prevotella, Faecalibacterium, Roseburia, Ruminococcus 
...
#Order data from greatest abundance to less
